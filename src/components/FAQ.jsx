...
const FAQ = () => {
    const faq = [
        ...
        },
        {
            ...
            </div><br/><br/>These questions linger among those who have fallen target to online trading scams victims. Forex and Cryptocurrencies have shaped the trading markets quite differently. Nowadays, more and more people have been susceptible to these scams.<br/>However, with PayBack, getting your money back quickly is not a problem.<br/><br/>Scams in online trading are connected to investment scams that are prevalent in the trading markets. They are often posted and advanced on social media sites, with fraud traders promising high returns along with popular endorsements from prominent people to encourage and attract people to trade and invest with them.<br/><br/>They pose as professionals with legitimate-looking websites to trick people into their scams.<br/><br/>PayBack provides solace for any online trading scams. The company helps people from trade platform scams and lets victims recover money from Bitcoin scam.`
        },
        {
            id: 5,
            title: "About Payback",
            content: `<div className=''></div><br/>These questions linger among those who have fallen target to online trading scams victims. Forex and Cryptocurrencies have shaped the trading markets quite differently. Nowadays, more and more people have been susceptible to these scams.<br/>However, with PayBack, getting your money back quickly is not a problem.<br/><br/>Scams in online trading are connected to investment scams that are prevalent in the trading markets. They are often posted and advanced on social media sites, with fraud traders promising high returns along with popular endorsements from prominent people to encourage and attract people to trade and invest with them.<br/><br/>They pose as professionals with legitimate-looking websites to trick people into their scams.<br/><br/>PayBack provides solace for any online trading scams. The company helps people from trade platform scams and lets victims recover money from Bitcoin scam.`
        },
    ]
  return (
    <>
        <div className='mt-20'>
            <div className='md:w-[50%] w-full md:px-0 px-6 m-auto m-[0px]'>
                <h1 className='text-center font-bold md:text-[40px] md:leading-[40px] text-[30px] text-primary'>More about Payback and the chargeback industry </h1>
            </div>
